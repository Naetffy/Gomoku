...
public class Board {
	...
	/**
	 * Checks for a winning condition along the diagonal line (from top-right to bottom-left)
	 * originating from the specified row and column.
	 *
	 * @param row    The row coordinate of the last move.
	 * @param column The column coordinate of the last move.
	...
	/**
	 * Checks for a winning condition along the horizontal line originating from the specified row and column.
	 *
	 * @param row    The row coordinate of the last move.
	 * @param column The column coordinate of the last move.
	 * @return True if a winning condition is met, false otherwise.
	...
	/**
	 * Checks for a winning condition along the vertical line originating from the specified row and column.
	 *
	 * @param row    The row coordinate of the last move.
	 * @param column The column coordinate of the last move.
	 * @return True if a winning condition is met, false otherwise.
